  ...
  return (
    <div style={{ backgroundColor: '#09090F',minHeight: '100vh',width:'100vw', padding: '0',margin:'0',boxSizing:'border-box'}}>
      <div style={{padding:"150px",marginLeft:'150px'}} >
        <h1 style={{color:"#FFFFFF",fontSize:'35px',fontFamily: 'Heltar'}}>Data Processing Agreement</h1>
        <p>Date: September 27, 2023<br/><br/>
        This Data Processing Agreement (the "Agreement") is entered into by and between:</p>
        <p>Your Company Name, a company registered under the laws of Your Country, having its registered office at Your Address ("Processor")</p>
        <br/>
        <p>Customer Name, a company registered under the laws of Customer's Country, having its registered office at Customer's Address ("Controller").</p>
        <br/>
        <p>(hereinafter collectively referred to as the "Parties").</p>
        ...
        <p>This Agreement may be executed in any number of counterparts, each of which shall be deemed an original and all of which together shall constitute one and the same instrument.</p>
      </div>
